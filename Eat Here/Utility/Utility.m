...
+(UIImage*)setImage:(NSMutableDictionary*)dict
{
    UIImage *categoryImage;
    
    NSMutableArray* BBqArray = [self convertString:BBQ];
    NSMutableArray* FASTFOODArray =[self convertString:FASTFOOD];
    NSMutableArray* HEALTHYCHOICEArray =[self convertString:HEALTHY];
    NSMutableArray* AroundArray = [self convertString:AROOUNDME];  //icon
    NSMutableArray* termsArray = [self convertString:TERMS]; //icon
    NSMutableArray* BARArray =[self convertString:BARS];
    NSMutableArray* EATTHEWORLDArray =[self convertString:EAT_WORLD];
    NSMutableArray* CAFEArray = [self convertString:CAFE];
    NSMutableArray* DESSERTArray =[self convertString:Deserts];
    NSMutableArray* VEGANArray =[self convertString:Vegan];
    NSMutableArray* highRateArray =[self convertString:HIGH_RAT]; //icon
    ...
    {
        categoryImage =[UIImage imageNamed:@"fastfood_big"];
    }
    else if ([BARArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"bar_big"];
    }
    else if ([BBqArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"bbq_big"];
    }
    else if ([AroundArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"bbq_big"];
    }
    else if ([termsArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"bbq_big"];
    }
    else if ([highRateArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"bbq_big"];
    }
    else if ([CAFEArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"cafe_big"];
    }
    else if ([DESSERTArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"dessert_big"];
    }
    else if ([HEALTHYCHOICEArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"healthy_big"];
    }
    else if ([VEGANArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"vegan_big"];
    }
    else if ([EATTHEWORLDArray containsObject:title])
    {
        categoryImage =[UIImage imageNamed:@"world_big"];
    }
    else
    {
        categoryImage =[UIImage imageNamed:@"world_big"];
...
+(UIImage *)GetImageFromcategoryName:(NSString *)name
{
    UIImage *categoryImage;
    ...
    {
        categoryImage =[UIImage imageNamed:@"nearme_big"];
    }
    ...
    {
        categoryImage =[UIImage imageNamed:@"highest_rated_big"];
    }
...
+(NSMutableArray *)convertString:(NSString *)str
{
    NSArray *convertedArr = [str componentsSeparatedByString:@","];
    return [convertedArr mutableCopy];

}
+(void)PushtoLoginPage:(UINavigationController *)navigationController
{
    AppDelegate *del = (AppDelegate *)[UIApplication sharedApplication].delegate;
    EnterMobileViewController *enterMobile =[[del grabStoryboard] instantiateViewControllerWithIdentifier:@"EnterMobileViewController"];
    enterMobile.fromUpdateScreen = false;
    [navigationController pushViewController:enterMobile animated:YES];
